...
import re
import inspect
from Lib.TCS_lib import *

class Test_API:
    """
    This Class verify all functional and Non functional test cases of API testing
    """
    def __init__(self, url):
        self.url = url

    @Testwrapper
    def TC1_Verify_get_response(self):
        """
    ...
    @Testwrapper
    def TC3_Verify_pagination(self):
        """
    ...
    @Testwrapper
    def TC4_Verify_user_email(self):
        """
